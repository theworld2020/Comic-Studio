...
interface LuckyModalProps {
  isOpen: boolean;
  onClose: () => void;
  onGenerate: (country: string, genre: string) => void;
}
...
const LuckyModal: React.FC<LuckyModalProps> = ({ isOpen, onClose, onGenerate }) => {
  ...
  const handleGenerateClick = () => {
    onGenerate(selectedCountry, selectedGenre);
  };
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-40 p-4">
      <div className="bg-white p-8 rounded-3xl shadow-lg border-4 border-banana-yellow w-full max-w-lg space-y-6">
        <h2 className="text-3xl font-bold text-center text-jungle-green">I Feel Lucky!</h2>
        <div className="space-y-4">
          <div>
            <label htmlFor="country-select" className="text-xl font-bold text-banana-brown mb-2 block">
          ...
          <div>
            <label htmlFor="genre-select" className="text-xl font-bold text-banana-brown mb-2 block">
              What kind of story?
            </label>
            <select
              id="genre-select"
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <button
            ...
            className="w-full sm:w-auto px-8 py-3 bg-jungle-green text-white text-xl font-bold rounded-full shadow-lg hover:bg-teal-600 transform hover:scale-105 transition-all duration-300"
          >
            Generate Story
          </button>
          <button
